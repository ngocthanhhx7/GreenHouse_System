...
function createSystemSettingService({ repository = createModelRepository(), auditLogger = { log: logAudit } } = {}) {
...
module.exports = { createSystemSettingService, systemSettingService: createSystemSettingService() };
