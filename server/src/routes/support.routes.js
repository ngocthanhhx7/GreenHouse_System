...
router.patch('/support-requests/:id/reopen', authenticate, authorizeRoles('Customer'), supportController.reopenCustomerRequest);
...
router.patch('/staff/support-requests/:id/claim', authenticate, authorizeRoles('Staff'), supportController.claimRequest);
