...
router.post('/staff/orders/:id/cod-collection', authenticate, authorizeRoles('Staff'), validateObjectIdParam(), codController.recordStaffCollection);
...
router.post('/staff/orders/:id/cod-recovery', authenticate, authorizeRoles('Staff'), validateObjectIdParam(), codController.finalizeRecovery);
